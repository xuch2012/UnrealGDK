...
void USpatialGameEngine::TickWorldTravel(FWorldContext& WorldContext, float DeltaSeconds)
{
	Super::TickWorldTravel(WorldContext, DeltaSeconds);
}

EBrowseReturnVal::Type USpatialGameEngine::Browse(FWorldContext& WorldContext, FURL URL, FString& Error)
{
	Error = TEXT("");
