# Directory structure
The table below lists the contents of the GDK for Unreal repository after running `Setup.bat` to build the Unreal engine as part of [Get started]({{urlRoot}}/content/get-started/get-started).
